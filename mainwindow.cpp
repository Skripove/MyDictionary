...
{
    QMessageBox::about(this, tr("Справка"),
                       tr("<h4>Главное окно:</h4>"
                          ...
                          "поле отображения картинки, ассоциирущейся со словом, кнопки Загрузить изображение и Готово.</p>"

                          "<p>\tКнопка \"Загрузить изображение\" - открывает окно выбора желаемого изображения. Если не загружать изображение, "
